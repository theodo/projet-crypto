    ...
    constructor(props) {
        ...
        render()
        {
            ...
            if (!this.state.isDataLoaded) {
                return (<p>Fetching CRYTPO data...</p>);
            }
            if (this.state.requestFailed) {
                ...
                return (
                    <Table>
                        ...
                        <Table.Body>
                            {data.filter((elem) => {
                                const spread = (Math.max(elem[Object.getOwnPropertyNames(elem)[1]][7].price, elem[Object.getOwnPropertyNames(elem)[1]][5].price, elem[Object.getOwnPropertyNames(elem)[1]][6].price, elem[Object.getOwnPropertyNames(elem)[1]][0].price) - Math.min(elem[Object.getOwnPropertyNames(elem)[1]][5].price, elem[Object.getOwnPropertyNames(elem)[1]][7].price, elem[Object.getOwnPropertyNames(elem)[1]][6].price, elem[Object.getOwnPropertyNames(elem)[1]][0].price))/Math.max(elem[Object.getOwnPropertyNames(elem)[1]][9].price, elem[Object.getOwnPropertyNames(elem)[1]][8].price, elem[Object.getOwnPropertyNames(elem)[1]][6].price, elem[Object.getOwnPropertyNames(elem)[1]][0].price)*100
                                elem.spread = spread
                                ...
                                return (
                                    <Table.Row>
                                        ...
                                        <Table.Cell>{'$' + String(elem[Object.getOwnPropertyNames(elem)[1]][5].price).slice(0, 5)}</Table.Cell>
                                        <Table.Cell>{'$' + String(elem[Object.getOwnPropertyNames(elem)[1]][7].price).slice(0, 5)}</Table.Cell>
                                        <Table.Cell positive>{elem.spread+'%'}</Table.Cell>
                                    </Table.Row>)
